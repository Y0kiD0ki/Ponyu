...
#MUSIC
bg_music = pygame.mixer.music.load('Music/8bit_Dungeon.mp3')
...
cinnabon_delights_font = pygame.font.SysFont('Georgia', 40, True, True)
...
boss_dialogue1 = pygame.image.load('Dialogue/dialogue1_boss_x300.png')
boss_dialogue2 = pygame.image.load('Dialogue/dialogue2_boss_x300.jpg')
...
while run:
    ...
    #Once Poñyu collects enough Cinnabons, the background is static and Poñyu moves to the boss level
    if cinnabon_delights >= 250:
        ...
        #Activates dialogue sequence and fades into black, transition to boss level
